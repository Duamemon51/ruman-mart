    ...
    <div className="flex min-h-screen flex-col bg-[#f5f7fb] text-slate-800">
      ...
      <main className="flex-1">
        <section className="relative isolate overflow-hidden bg-[#031a3b]">
          <Image src="/hero.png" alt="Ruman Mart deals" fill priority sizes="100vw" quality={100} className="scale-[1.12] object-cover object-center brightness-90 saturate-110 md:scale-[1.06] lg:scale-[1.02]" />
